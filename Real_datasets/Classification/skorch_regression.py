...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 18 09:33:39 2023
...
## Subclass skorch for regression model
...
class NeuralNet_regression:
    ...
    def proximal_operator(self, non_linear_weights, linear_weights, lambda1):
        ...
        v1 = self.gl_operator(non_linear_weights, l * lambda1 * (1 - self.alpha)).astype('float32')
        v1 = np.concatenate((v1, linear_weights))
        v2 = self.gl_operator(v1, l * lambda1 * self.alpha).astype('float32') 
        return(v2)
