...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep  5 11:11:12 2023
...
Code to perform cross validation on classification datasets.
...
### Create the class to perform cross validation for classification

class CrossValidation_classification:
    def __init__(
            self,
            module,
            criterion,
    ...
    def obtain_seq_lambda(self, X, y, nlambdas, alpha):
        ...
        while k != "Stop":
            ...
            sum_total = 0
            for name, param in list(net.module_.named_parameters())[1:]:
...
### Fit final model with optimal hyperparameters for classification model

class final_model_classification:
    def __init__(
            self,
            module,
            criterion,
